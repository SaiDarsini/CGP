...
interface OfficerComplaintDetailProps {
  complaint: Complaint & {
...
export function OfficerComplaintDetail({ complaint, history, userId }: OfficerComplaintDetailProps) {
  ...
  const canUpdate = complaint.status !== 'resolved' && complaint.status !== 'rejected'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <Link 
            href="/dashboard/officer/assigned" 
          ...
          {canUpdate && (
            <Card className="border-primary/50">
              <CardHeader>
                ...
                <CardDescription>Change the complaint status and add notes</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
